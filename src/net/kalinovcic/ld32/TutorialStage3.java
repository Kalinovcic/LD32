...
public class TutorialStage3 implements Stage
{
    ...
    public void render()
    {
        ...
        LD32.font.drawString(100, 355, "before you are overwhelmed. Activate it with [left control]", 1, -1, TrueTypeFont.ALIGN_LEFT);
        LD32.font.drawString(100, 380, "or [right control].", 1, -1, TrueTypeFont.ALIGN_LEFT);
